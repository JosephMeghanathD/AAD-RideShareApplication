...
export default function NavBar() {
  return (
    // Changed bg-white to bg-gray-900 and replaced shadow with a bottom border
    <nav className="bg-gray-900 border-b border-gray-700 w-full">
      <div className="container mx-auto px-6 py-3 flex justify-between items-center">
        {/* Site Title: Changed text color to white */}
        <Link 
          to="/" 
        ...
        <ul className="flex items-center list-none gap-6">
          ...
          <li>
            {/* This button style works perfectly on both light and dark backgrounds */}
            <Link 
              to={localStorage.getItem('jwtToken') === null ? "/login" : "/user"}
